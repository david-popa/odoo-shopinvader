...
from odoo.addons.shopinvader_product_rating.tests.common import CommonRatingCase
...
class RatingCase(CommonRatingCase):
    ...
    def test_upvote(self):
        ...
        self.assertEqual('The record does not exist or you cannot upvote it', em.exception.args[0])
